...
public class UserProfile {
    ...
    private String imageUrls; // ([UR1], [URL2], [URL3])
    private String bio;
    ...
    private Drinks drinks; // Never, socially, often
    private Drugs drugs; // Never, socially, often
    private Education education; // master, bachelor, high school, phd, other
    private Integer height;
    // Getters and setters

    public Integer getProfileId() { return id; }
    public void setProfileId(Integer id) { this.id = id; }
